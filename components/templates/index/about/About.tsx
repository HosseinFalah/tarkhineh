const About = () => {
    return (
        <div className="about_img mt-[72px] h-[338px] md:h-[390px]">
            <div className="max-w-screen-xl m-auto container py-4 px-5 sm:py-12">
                <div className="flex items-center justify-between flex-wrap gap-y-6">
                    <div className="lg:max-w-[28rem] xl:max-w-[37.5rem]">
                        <h4 className="text-white text-base md:text-xl lg:text-2xl font-normal md:font-bold lg:font-bold pb-2 nd:pb-6">رستوران‌های زنجیره‌ای ترخینه</h4>
                        <p className="text-white text-[10px] md:text-base lg:text-xl font-normal leading-[1.125rem] lg:leading-[2.25rem] pb-4 text-justify">
                        ...
                        <button className="text-white px-4 py-2 border w-[152px] md:w-[184px] text-center text-xs md:text-base rounded flex items-center justify-center gap-x-2 mr-auto">
                            اطلاعات بیشتر
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="stroke-white w-4 h-4 md:w-6 md:h-6 cursor-pointer">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 19.5 8.25 12l7.5-7.5" />
                            </svg>
                        </button>
                    </div>
                    <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-2 gap-x-12 md:gap-x-2 lg:gap-x-6 gap-y-4 sm:gap-y-2 text-center w-full lg:w-auto">
                        <div className="py-1 sm:py-4">
                            <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="m-auto w-6 h-6 md:w-12 md:h-12">
                            ...
                            <span className="text-white pt-1 md:pt-4 block text-xs md:text-lg">پرسنلی مجرب و حرفه‌ای</span>
                        </div>
                        <div className="py-1 sm:py-4">
                            <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="m-auto w-6 h-6 md:w-12 md:h-12">
                            ...
                            <span className="text-white pt-1 md:pt-4 block text-xs md:text-lg">کیفیت بالای غذاها</span>
                        </div>
                        <div className="py-1 sm:py-4">
                            <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="m-auto w-6 h-6 md:w-12 md:h-12">
                            ...
                            <span className="text-white pt-1 md:pt-4 block text-xs md:text-lg">محیطی دلنشین و آرام</span>
                        </div>
                        <div className="py-1 sm:py-4">
                            <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="m-auto w-6 h-6 md:w-12 md:h-12">
                            ...
                            <span className="text-white pt-1 md:pt-4 block text-xs md:text-lg">منوی متنوع</span>
                        </div>
                    </div>
                </div>
            </div>
