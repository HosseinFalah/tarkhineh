            ...
            >
                <SwiperSlide>
                    <div className="relative h-full">
                        ...
                        <button className="text-[10px] cursor-pointer md:text-base rounded bg-primary p-2 md:px-4 text-white text-center flex items-center justify-center absolute z-10 h-6 w-24 md:h-10 md:w-48 left-0 right-0 mx-auto bottom-10 md:bottom-16">سفارش آنلاین غذا</button>
